  ...
  return (
    <div className="App">
      ...
      <div id="functions">
        <div className="container">
          <div className="searching">
            ...
            <input onChange={(e)=> handleInput(e)} type="text" placeholder='Axtardiginiz olkeni daxil edin' />
          </div>
          <div className="filtering">
            <select value={selectVal} onChange={(e)=>handleFilter(e) } name="" id="">
      ...
      <div className="products_container">
       { products
       .filter(x=>x.name.common.toLowerCase().includes(inputValue.toLowerCase()))
